...
/**
 * Derived from `org.mongodb:bson:5.1.1`:
 *  - org.bson.types.ObjectId.java
 *  - org.bson.assertions.Assertions.java
 * Represents a 24-character string ObjectId.
 * This is a globally unique, trend-increasing ID, but not globally ordered.
 * Consists of:
 *  - 4-byte timestamp
 *  - 5-byte random value
 *  - 3-byte incrementing counter
 * Each service instance can generate up to 16,777,216 unique IDs per second.
 */
