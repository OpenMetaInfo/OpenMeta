...
public enum NodeGetDataType {
    ...
    public static final Set<NodeGetDataType> SINGLE_ROW_TYPES = Sets.immutableEnumSet(SINGLE_ROW, ONE_FIELD_VALUE);
    // The types of multiple row data
    public static final Set<NodeGetDataType> MULTI_ROW_TYPES = Sets.immutableEnumSet(MULTI_ROWS, ONE_FIELD_VALUES);
    // Types that involve using count to count
    public static final Set<NodeGetDataType> COUNT_TYPES = Sets.immutableEnumSet(EXIST, COUNT);
}
